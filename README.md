...
- **视频播放**：支持多种视频格式，流畅播放
- **YouTube集成**：支持直接输入YouTube链接播放视频和字幕，无需下载
...
### v1.2.0 (2024-05-01)
- 添加YouTube视频集成功能，支持直接播放YouTube视频和字幕
- 优化视频控制界面，添加音量图标点击功能
- 彻底重写字幕导航算法，使用二分查找优化性能，修复字幕跳转过远的问题
- 改进字幕定位逻辑，提高字幕跳转的准确性和响应速度
- 优化YouTube视频字幕循环播放功能，支持与本地视频相同的循环体验
- 添加字幕位置智能判断，当用户在字幕前20%位置时点击"上一句"会跳转到上一个字幕，否则跳转到当前字幕开始位置
