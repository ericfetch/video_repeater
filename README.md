...
- **词典管理**：支持导入CSV/JSON格式词典，设置目标词汇，生词本优先标识词典单词，在听力练习中强化目标词汇
...
### v1.1.5 (2024-05-20)
- 修复了CSV词典导入时中文显示乱码的问题，现在可以正确显示中文定义
- 优化了词典文件的导入速度，大文件导入更快捷
- 改进了单词查询功能，即使网络不稳定也能正确获取单词释义
- 解决了之前偶尔出现的导入词典后应用崩溃的问题
- 增强了单词音标显示，支持更多特殊音标符号
...
**Q: CSV词典导入时出现中文乱码怎么办？**  
A: 最新版本已改进对中文编码的支持。如果仍然出现乱码，请尝试将CSV文件保存为UTF-8编码格式，或者使用Excel另存为CSV时选择UTF-8编码。如果问题仍然存在，可以尝试先将CSV转换为JSON格式后再导入。
